...
var _emilianobovetti$edit_distance$EditDistance$last = function (list) {
	last:
	while (true) {
		var _p0 = list;
		if (_p0.ctor === '::') {
...
var _emilianobovetti$edit_distance$EditDistance$min3 = F3(
	function (a, b, c) {
		return ((_elm_lang$core$Native_Utils.cmp(a, b) < 1) && (_elm_lang$core$Native_Utils.cmp(a, c) < 1)) ? a : ((_elm_lang$core$Native_Utils.cmp(b, c) < 1) ? b : c);
	});
var _emilianobovetti$edit_distance$EditDistance$patternLoop = F7(
	function (textHead, pattern, idx, b0, b1, b2, prev) {
		var _p1 = {ctor: '_Tuple2', _0: pattern, _1: prev};
		if ((_p1.ctor === '_Tuple2') && (_p1._0.ctor === '::')) {
			if (_p1._1.ctor === '::') {
				var b2_ = _elm_lang$core$Native_Utils.eq(textHead, _p1._0._0) ? b0 : (1 + A3(_emilianobovetti$edit_distance$EditDistance$min3, b0, b1, b2));
				var b1_ = _p1._1._0;
				var b0_ = b1;
				return {
					ctor: '::',
					_0: b2_,
					_1: A7(_emilianobovetti$edit_distance$EditDistance$patternLoop, textHead, _p1._0._1, idx + 1, b0_, b1_, b2_, _p1._1._1)
				};
			} else {
				return _elm_lang$core$Native_Utils.eq(textHead, _p1._0._0) ? {
					ctor: '::',
					_0: b0,
					_1: {ctor: '[]'}
				} : {
					ctor: '::',
					_0: 1 + A3(_emilianobovetti$edit_distance$EditDistance$min3, b0, b1, b2),
					_1: {ctor: '[]'}
				};
			}
		} else {
...
var _emilianobovetti$edit_distance$EditDistance$initPatternLoop = F4(
	function (textHead, pattern, b0, prevCol) {
		var _p2 = prevCol;
		if (_p2.ctor === '::') {
			return A7(_emilianobovetti$edit_distance$EditDistance$patternLoop, textHead, pattern, 1, b0, _p2._0, b0 + 1, _p2._1);
		} else {
			return {ctor: '[]'};
		}
	});
var _emilianobovetti$edit_distance$EditDistance$textLoop = F4(
		...
		while (true) {
			...
			if (_p3.ctor === '::') {
				var _v5 = _p3._1,
					_v6 = pattern,
					_v7 = idx + 1,
					_v8 = A4(_emilianobovetti$edit_distance$EditDistance$initPatternLoop, _p3._0, pattern, idx - 1, col);
				text = _v5;
				pattern = _v6;
				idx = _v7;
				col = _v8;
...
var _emilianobovetti$edit_distance$EditDistance$levenshtein = F2(
	function (text, pattern) {
		levenshtein:
		while (true) {
			var _p4 = {ctor: '_Tuple2', _0: text, _1: pattern};
			if (_p4._0.ctor === '[]') {
				return _elm_lang$core$List$length(pattern);
			} else {
				if (_p4._1.ctor === '[]') {
					return _elm_lang$core$List$length(text);
				} else {
					if (_p4._0._1.ctor === '[]') {
						return A2(
							_elm_lang$core$List$any,
							...
							pattern) ? (_elm_lang$core$List$length(pattern) - 1) : _elm_lang$core$List$length(pattern);
					} else {
						if (_p4._1._1.ctor === '[]') {
							return A2(
								_elm_lang$core$List$any,
								...
								text) ? (_elm_lang$core$List$length(text) - 1) : _elm_lang$core$List$length(text);
						} else {
							if (_elm_lang$core$Native_Utils.eq(_p4._0._0, _p4._1._0)) {
								var _v10 = _p4._0._1,
									_v11 = _p4._1._1;
								text = _v10;
								pattern = _v11;
								...
								return A2(
									...
									-1,
									_emilianobovetti$edit_distance$EditDistance$last(
										A4(
											_emilianobovetti$edit_distance$EditDistance$textLoop,
											text,
											pattern,
											1,
											A2(
												_elm_lang$core$List$range,
												1,
												_elm_lang$core$List$length(pattern)))));
							}
						}
					}
				}
...
var _emilianobovetti$edit_distance$EditDistance$levenshteinOfStrings = F2(
	function (text, pattern) {
		return A2(
			_emilianobovetti$edit_distance$EditDistance$levenshtein,
...
var _user$project$Src_Functions$countHelper = function (chars) {
	...
	var $char = _elm_lang$core$String$fromChar(
		A2(
			...
			_elm_lang$core$List$head(chars)));
	return {
		ctor: '_Tuple2',
		_0: $char,
...
var _user$project$Main$filterPeopleHelper = function (maybePeople) {
	...
	if (((_p0.ctor === '_Tuple2') && (_p0._0.ctor === 'Just')) && (_p0._1.ctor === 'Just')) {
		return _elm_lang$core$Maybe$Just(
			{
				id: _p0._0._0,
				display_name: A2(_elm_lang$core$Maybe$withDefault, '', maybePeople.display_name),
				email_address: _p0._1._0,
				title: A2(_elm_lang$core$Maybe$withDefault, '', maybePeople.title)
			});
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
				...
				_elm_lang$core$List$head(
					A2(
						...
						A2(
							_elm_lang$core$List$filter,
							function (t) {
								return _elm_lang$core$Native_Utils.eq(t.id, rowId);
							},
							people)))));
	});
...
var _user$project$Main$renderTable = F2(
	function (headers, rows) {
		var headerHelper = function (t) {
			return A2(
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							_elm_lang$html$Html$tr,
							{ctor: '[]'},
							A2(_elm_lang$core$List$map, headerHelper, headers)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						A2(_elm_lang$core$List$map, bodyHelper, rows)),
					_1: {ctor: '[]'}
				}
			});
	});
			...
			case 'UniqueCharacters':
				...
				if (_p4.ctor === 'Just') {
					...
					return A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Please select a person'),
							_1: {ctor: '[]'}
						});
				}
			default:
				return A2(
					...
					_user$project$Main$possibleDuplicates(people));
		}
	});
var _user$project$Main$renderHeader = function () {
	var divStyle = {
		ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Display Name'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Main$renderRow = F2(
	function (rowId, person) {
		var backgroundColor = _elm_lang$core$Native_Utils.eq(
			rowId,
			_elm_lang$core$Maybe$Just(person.id)) ? '#eee' : 'white';
		var divStyle = {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'text-align', _1: 'center'},
			_1: {
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(person.email_address),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(person.display_name),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Main$render = F2(
	function (model, people) {
		var className = function (t) {
			return _elm_lang$core$Native_Utils.eq(model.showType, t) ? 'btn btn-primary' : 'btn btn-default';
		};
		var btnStyle = {
			ctor: '::',
			...
			},
			{
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Show None'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Show Unique Characters'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									A2(
										_elm_lang$core$List$map,
										function (t) {
											return A2(_user$project$Main$renderRow, model.rowId, t);
										},
										people)),
								_1: {ctor: '[]'}
							}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(_user$project$Main$renderDetails, model, people),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
